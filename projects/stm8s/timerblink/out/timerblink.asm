...
dmcsr2	ds.b
dmenfctr	ds.b
flash	segment byte at 8000-BFFF 'rom'
...
dumb
	iret		; iret in timerblink.stm8s._ : 45
tmr1handler
	btjf tim1sr1,#0,otherint		; iftim1sr1#0==0otherint in timerblink.stm8s._ : 48
	bres tim1sr1,#0		; tim1sr1#0=#0 in timerblink.stm8s._ : 49
	bcpl gpioeodr,#5		; !gpioeodr#5 in timerblink.stm8s._ : 50
otherint
	iret		; iret in timerblink.stm8s._ : 51
systemclockinit
...
init
	bset gpioeddr,#5		; gpioeddr#5=#1 in timerblink.stm8s._ : 56
	bset gpioecr1,#5		; gpioecr1#5=#1 in timerblink.stm8s._ : 57
	clr tim1cr2		; tim1cr2=#0 in timerblink.stm8s._ : 59
	clr tim1smcr		; tim1smcr=#0 in timerblink.stm8s._ : 60
	clr tim1etr		; tim1etr=#0 in timerblink.stm8s._ : 61
	bset tim1ier,#0		; tim1ier#0=#1 in timerblink.stm8s._ : 62
	clr tim1pscrh		; tim1pscrh=#0 in timerblink.stm8s._ : 63
	mov tim1pscrl,#50		; tim1pscrl=#50 in timerblink.stm8s._ : 64
	bset tim1cr1,#2		; tim1cr1#2=#1 in timerblink.stm8s._ : 65
	bset tim1cr1,#0		; tim1cr1#0=#1 in timerblink.stm8s._ : 66
	ret		; ret in timerblink.stm8s._ : 67
start
	ldw x,#$07ff		; x=#0x07ff in timerblink.stm8s._ : 70
	ldw sp,x		; sp=x in timerblink.stm8s._ : 70
	callr systemclockinit		; callnearsystemclockinit in timerblink.stm8s._ : 71
	callr init		; callnearinit in timerblink.stm8s._ : 72
	rim		; i=#0 in timerblink.stm8s._ : 73
loop
	nop		; nop in timerblink.stm8s._ : 74
	jra loop		; gonearloop in timerblink.stm8s._ : 75
