...
delay60k
	ldw x,#65530		; x=#65530 in blink.stm8s._ : 25
delay60local
	decw x		; x-- in blink.stm8s._ : 26
	jrne delay60local		; ifz==0delay60local in blink.stm8s._ : 27
	ret		; ret in blink.stm8s._ : 28
start
	ldw x,#$03ff		; x=#0x03ff in blink.stm8s._ : 44
	ldw sp,x		; sp=x in blink.stm8s._ : 44
	bset gpioaddr,#3		; gpioaddr#3=#1 in blink.stm8s._ : 46
	bset gpioacr1,#3		; gpioacr1#3=#1 in blink.stm8s._ : 46
loop
	callr delay60k		; callneardelay60k in blink.stm8s._ : 48
	bcpl gpioaodr,#3		; !gpioaodr#3 in blink.stm8s._ : 49
	jra loop		; gonearloop in blink.stm8s._ : 50
